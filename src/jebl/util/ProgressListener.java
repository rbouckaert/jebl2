 ...
 * @author Matt Kearse
 *
 * @version $Id: ProgressListener.java 1068 2010-09-08 23:59:59Z matt_kearse $
 *
...
/*    public final boolean setComplete() {
    ...
    /**
     * Equivalent to {@link #addFeedbackAction(String, String, jebl.util.SimpleListener) addFeedbackAction(label,"",listener)}
     */
     ...
     * {@link #addFeedbackAction(String, jebl.util.SimpleListener)}.
     * @param label The  label used as a parameter to {@link #addFeedbackAction(String, jebl.util.SimpleListener)}
     */
